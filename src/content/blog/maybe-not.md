...
You’ve seen me [brag about the system I used](https://ale.today/how-to-read-10x-more-books/) to read (what I considered to be) a reasonable amount of books over a year. But this year I decided that, while the system works, it kinda steals the fun out of pretty much any activity you apply it to.
...
Enjoying the process, and not focusing on any result is something I’ve discussed many times at therapy, so _in theory_ it’s something I should’ve internalized long ago. But of course I didn’t, and something had to happen to remind me about it:
...
Have I stopped looking at my stress levels, body battery, or training load? _Of course not._ But is there a clear “before” and “after” moment about these (and other quantified) things since then? You betcha.

I’m not yet ready to give up some of my training info, because it is important to me. I’m old enough to know that “exercising” is no longer something I only do for fun, and I _have to_ measure some stuff.
